        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div
                className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 backdrop-blur-sm animate-flow-up"
              ...
              <h1 
                className="text-5xl lg:text-7xl font-bold leading-tight animate-flow-up"
              ...
              <p 
                className="text-xl text-gray-300 leading-relaxed max-w-lg animate-flow-up"
            ...
            <div 
              className="flex flex-col sm:flex-row gap-4 animate-flow-up"
            ...
            {/* Stats */}
            <div 
              className="grid grid-cols-3 gap-6 pt-8 animate-flow-up"
          ...
          <div 
            className="relative float-animation animate-flow-up"
...
.animate-flow-up {
  animation: flow-up 0.8s ease-out forwards;
  opacity: 0;
}
*/